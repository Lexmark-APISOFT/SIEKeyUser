<%@ Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true" CodeBehind="confirmar_reembolso.aspx.cs" Inherits="SIE_KEY_USER.Views.confirmar_reembolso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <form id="confirmar_datos" runat="server">
        ...
        <div class="center">
            ...
            <asp:Label ID="aviso_confirmar" ClientIDMode="Static" runat="server" Text="Reembolso aceptado exitosamente"></asp:Label>
