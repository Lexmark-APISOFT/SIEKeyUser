<%@Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true" CodeBehind="Mantenimiento_Catalogos.aspx.cs" Inherits="SIE_KEY_USER.Views.Mantenimiento_Catalogos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <form id="mant_catalogos_form" runat="server" >
        ...
        <!--<asp:GridView ID="Grid_Clinica" runat="server" ClientIDMode="Static" PageSize="4" AllowPaging="True" CssClass="grid1" PagerStyle-CssClass="pgt"   AutoGenerateColumns="False"  OnPageIndexChanging="Grid_Clinica_PageIndexChanging"  >
            <AlternatingRowStyle Wrap="True" />
            <Columns>
                <asp:BoundField DataField="numclinica" HeaderText="Número clínica" />
                <asp:BoundField DataField="refubicacion" HeaderText="Referencia ubicación" />
...
<PagerStyle CssClass="pgt"></PagerStyle>
                    ...
                    -->
                    <asp:GridView ID="Grid_Correo" runat="server" ClientIDMode="Static" PageSize="4" AllowPaging="True" CssClass="grid1" PagerStyle-CssClass="pgt"  OnRowCommand="Grid_Correo_RowCommand" AutoGenerateColumns="False" OnPageIndexChanging="Grid_Correo_PageIndexChanging">
                        <Columns>
                            <asp:BoundField DataField="dominio" HeaderText="Descripción dominio" />
                            <asp:TemplateField HeaderText="Modificar">
                   <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Eliminar">
                    ...
                    <!--<div id="botones_agreg_catalogos">
                        <table id="botones_add_catalogos">
                            <tr>
                                <td ><asp:Button ID="agregar_clinica" runat="server" CssClass="btn" Text="Agregar clínica"  /></td>
                            </tr>                           
                        </table>

                    </div>-->
                    <div id="botones_agreg_dominio">
                        <table id="botones_add_dominio">
                            <tr>
                                <td ><asp:Button ID="agregar_correo" runat="server" CssClass="btn" Text="Agregar dominio" OnClick="agregar_correo_Click"  /></td>
                            </tr>                           
                        </table>
                    ...
                    <div id="botones_catalogos">
                        <table id="enlCatalogos">
                            <tr>
                                <td>
                                    <asp:Button ID="cat_sig" runat="server" CssClass ="btnCAT "  Text="Catálogos siguientes" OnClick="cat_sig_Click"   />
                                </td>
                            </tr>
                            <tr>
                                <td>
          ...
          <table id="tabla_modifcatalogo" runat="server">
              ...
              <tr>
                  <td >Descripción dominio:</td>
                  <td><asp:TextBox ID="Ddominio"  runat="server" Enabled="false" AutoCompleteType="Disabled" ></asp:TextBox></td>
