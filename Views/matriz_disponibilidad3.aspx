<%@ Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true"  CodeBehind="matriz_disponibilidad3.aspx.cs" Inherits="SIE_KEY_USER.Views.matriz_disponibilidad3" %>
    ...
    <link href="~/Content/Vacaciones.css" rel="stylesheet" type="text/css" />
         <style>
             #txt-availability-input.availability-input {
                 width: 100%;
                 padding: 12px 20px;
                 margin: 8px 0;
                ...
                <div class="container-fluid">
                    ...
                    <div class="Row">
                        <div class="col-md-12">
                            ...
                            <asp:Button ID="btnApplyAll" runat="server" Text="Aplicar a la seleccion"  class="apply-availability-button"  OnClientClick="return false" CssClass="apply-availability-button" style="margin: 10px 10px 10px 10px;"/>                            
                        </div>
                    </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content" style="background-color:#1e9827;border-radius:35px;">
                      <div class="modal-body">
                        ...
                        <button id="btnAcceptAvailability" type="button" class="btn btn-success" style="border-radius: 15px !important;"  runat="server" >Aplicar</button>
