<%@ Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true" CodeBehind="Reembolso_rechazados.aspx.cs" Inherits="SIE_KEY_USER.Views.Reembolso_rechazados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <form id="prestamos_form" runat="server">
       ...
       <script>
        ...
        <asp:GridView ID="GridView1" runat="server" ClientIDMode="Static" PageSize="4" AllowPaging="True" CssClass="grid" PagerStyle-CssClass="pgt" OnPageIndexChanging="GridView1_PageIndexChanging">
