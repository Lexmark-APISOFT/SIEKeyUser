<%@ Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true" CodeBehind="Actualizacion_datos.aspx.cs" Inherits="SIE_KEY_USER.Views.actualizacion_datos" %>
    ...
    <form id="actualizacion_form" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Path="~/Content/Actualizacion_datos.css" />
            </Scripts>
        </asp:ScriptManager>
        <!-------------------------------------------------------- FIN -------------------------------------->
        ...
        <div>
            <asp:Image ID="printing" Width="15%" ClientIDMode="Static" runat="server" ImageUrl="~/Images/loading.gif" Visible="True" CssClass="gifLoading" />
        </div>
       <%-- <asp:CheckBox ID="CheckBox1" runat="server" OnCheckedChanged="CheckBox1_CheckedChanged" AutoPostBack ="true" /><asp:Label ID="Label2" runat="server" Text=" PeopleSoft"></asp:Label>--%>
        <div id="center_ac">
            <div style="overflow-x:auto;  height:450px; width:100%" >
                <asp:GridView ID="GridView1" runat="server" AllowPaging="false" CssClass="grid" PagerStyle-CssClass="pgt" SelectedIndex="-1" 
            ...
            <asp:Button ID="ok_modal" ClientIDMode="Static" runat="server" data-toggle="modal" Text="Generar archivo TRESS" CssClass="ok_actdat" OnClientClick="return false" />
            ...
            <asp:Button ID="irclinica" ClientIDMode="Static" runat="server" Text="PeopleSoft" OnClick="irclinica_Click" OnClientClick="PlaySound(); return true"/>
