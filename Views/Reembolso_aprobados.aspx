<%@ Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true" CodeBehind="Reembolso_aprobados.aspx.cs" Inherits="SIE_KEY_USER.Views.Reembolso_aprobados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <form id="prestamos_form" runat="server">
       ...
       <script>
        ...
        <asp:GridView ID="GridView1" runat="server" ClientIDMode="Static"  AllowPaging="false" CssClass="grid" PagerStyle-CssClass="pgt" OnPageIndexChanging="GridView1_PageIndexChanging">
...
<PagerStyle CssClass="pgt"></PagerStyle>
            ...
            <asp:Button ID="ok_modal" ClientIDMode="Static" runat="server" data-toggle="modal" Text="Generar archivo" Visible="false" CssClass="ok_actdat" OnClientClick="return false" />
