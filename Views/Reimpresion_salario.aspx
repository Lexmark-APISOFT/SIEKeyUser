<%@ Page Title="" Language="C#" MasterPageFile="~/_Layout.Master" AutoEventWireup="true" CodeBehind="Reimpresion_salario.aspx.cs" Inherits="SIE_KEY_USER.Views.Reimpresion_salario" Async="true" %>
        ...
        <div id="center_reimpresion">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Button ID="Button3" runat="server" Text="Cartas sin salario" OnClick="Button3_Click" />
            ...
            <%------------------------------------- FIN --------------------------------%>
             <asp:Button ID="constancia_trabajo" ClientIDMode="Static" runat="server" data-toggle="modal" Text="Constancia de trabajo" CssClass="ok_actdat" OnClick="generar_Click"  />
        <asp:Button ID="constancia_visa" ClientIDMode="Static" runat="server" data-toggle="modal" Text="Visa Láser" CssClass="ok_actdat" OnClick="generar_Click"  />
        <asp:Button ID="constancia_migracion" ClientIDMode="Static" runat="server" data-toggle="modal" Text="Migración" CssClass="ok_actdat" OnClick="generar_Click"   />
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <%--<asp:Button ID="aceptar_ac" ClientIDMode="Static" runat="server" Text="Sí" OnClick="aceptar_ac_Click" OnClientClick="PlaySound(); return true; window.open('google.com');" />--%>                            <%--<asp:Button ID="aceptar_ac" ClientIDMode="Static" runat="server" Text="Sí" OnClick="aceptar_ac_Click" OnClientClick="PlaySound();window.open('confirmar_datos.aspx');" />--%>
    ...
    <script type="text/javascript">
        ...
        <script>
            $(document).ready(function () {
               ...
               $.ajax({
                   url: 'Reimpresion_salario/PrintDocumentsAsync',
                    type: 'POST',
